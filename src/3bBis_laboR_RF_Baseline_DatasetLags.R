...
don_all=readRDS("/home/labdl/appli/bdf/users/n825781/df_lags_clean.RDS") 
...
str(don_all)
table(don_all$Y)
prop.table(table(don_all$Y)) #0.009371442%
...
saveRDS(resTest_RF,"/home/labdl/appli/bdf/users/n825781/df_DatasetLags_resTest_RF.RDS")
...
prop.table(table(as.numeric(resTest_RF$Y))) # 0.009315637%


#rocRF100 <- roc(resTest_RF$Y,resTest_RF$RF100)
#auc(rocRF100)#gives value of AUC=area under ROC curve: 
#plot(rocRF100)#graph of ROC

rocRF100_100l <- roc(resTest_RF$Y,resTest_RF$RF100_100l)#response, then predictor
auc(rocRF100_100l)#gives value of AUC=area under ROC curve: 0.7035
...
rocRF50_100l <- roc(resTest_RF$Y,resTest_RF$RF50_100l)#response, then predictor
auc(rocRF50_100l)#gives value of AUC=area under ROC curve: 0.6514
