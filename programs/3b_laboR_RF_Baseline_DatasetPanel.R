...
don_all=readRDS("/home/labdl/appli/bdf/users/n825781/df_clean.RDS") 
...
saveRDS(resTest_RF,"/home/labdl/appli/bdf/users/n825781/df_resTest_RF.RDS")
...
rocRF100 <- roc(resTest_RF$Y,resTest_RF$RF100)#response, then predictor
auc(rocRF100)#gives value of AUC=area under ROC curve: 0.8187
plot(rocRF100)#graph of ROC

rocRF100_100l <- roc(resTest_RF$Y,resTest_RF$RF100_100l)#response, then predictor
auc(rocRF100_100l)#gives value of AUC=area under ROC curve: 0.6694

rocRF50_50l<- roc(resTest_RF$Y,resTest_RF$RF50_50l)
auc(rocRF50_50l)#0.6676

rocRF50<- roc(resTest_RF$Y,resTest_RF$RF50)
auc(rocRF50)#0.7847125
